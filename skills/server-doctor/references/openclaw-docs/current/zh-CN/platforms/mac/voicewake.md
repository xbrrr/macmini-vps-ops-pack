<!-- Source: https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake -->
<!-- Title: 语音唤醒 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
...
-   [语音唤醒与按键通话](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [模式](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [运行时行为（唤醒词）](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [生命周期不变量](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [悬浮窗卡住的故障模式（之前的问题）](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [按键通话细节](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [面向用户的设置](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [转发行为](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [转发负载](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
-   [快速验证](https://docs.openclaw.ai/zh-CN/platforms/mac/voicewake)
...
[菜单栏](https://docs.openclaw.ai/zh-CN/platforms/mac/menu-bar)[语音浮层](https://docs.openclaw.ai/zh-CN/platforms/mac/voice-overlay)
