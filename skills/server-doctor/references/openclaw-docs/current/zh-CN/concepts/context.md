...
[跳转到主要内容](https://docs.openclaw.ai/zh-CN/concepts/context)
...
-   [快速开始（检查上下文）](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [示例输出](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [/context list](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [/context detail](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [什么计入上下文窗口](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [OpenClaw 如何构建系统提示词](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [注入的工作区文件（项目上下文）](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [Skills：注入的内容 vs 按需加载的内容](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [工具：有两种成本](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [命令、指令和”内联快捷方式”](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [会话、压缩和修剪（什么会持久化）](https://docs.openclaw.ai/zh-CN/concepts/context)
-   [/context 实际报告什么](https://docs.openclaw.ai/zh-CN/concepts/context)
...
“上下文”是 **OpenClaw 在一次运行中发送给模型的所有内容**。它受模型的**上下文窗口**（token 限制）约束。 新手心智模型：
...
另请参阅：[斜杠命令](https://docs.openclaw.ai/tools/slash-commands)、[Token 使用与成本](https://docs.openclaw.ai/reference/token-use)、[压缩](https://docs.openclaw.ai/concepts/compaction)。
...
系统提示词包含一个紧凑的 **Skills 列表**（名称 + 描述 + 位置）。此列表有实际开销。 Skill 指令默认_不_包含。模型应该**仅在需要时**`read` Skill 的 `SKILL.md`。
...
文档：[会话](https://docs.openclaw.ai/concepts/session)、[压缩](https://docs.openclaw.ai/concepts/compaction)、[会话修剪](https://docs.openclaw.ai/concepts/session-pruning)。
...
[系统提示词](https://docs.openclaw.ai/zh-CN/concepts/system-prompt)[智能体工作区](https://docs.openclaw.ai/zh-CN/concepts/agent-workspace)
