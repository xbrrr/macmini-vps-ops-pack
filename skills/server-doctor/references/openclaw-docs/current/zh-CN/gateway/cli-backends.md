<!-- Source: https://docs.openclaw.ai/zh-CN/gateway/cli-backends -->
<!-- Title: CLI 后端 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
...
-   [CLI 后端（回退运行时）](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [新手友好快速开始](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [作为回退使用](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [配置概览](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [配置示例](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [工作原理](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [会话](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [图像（传递）](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [输入 / 输出](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [默认值（内置）](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [限制](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
-   [故障排除](https://docs.openclaw.ai/zh-CN/gateway/cli-backends)
...
[工具调用 API](https://docs.openclaw.ai/zh-CN/gateway/tools-invoke-http-api)[本地模型](https://docs.openclaw.ai/zh-CN/gateway/local-models)
