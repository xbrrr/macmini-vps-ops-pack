<!-- Source: https://docs.openclaw.ai/zh-CN/providers/venice -->
<!-- Title: Venice AI - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/providers/venice)
...
-   [Venice AI（Venice 亮点）](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [为什么在 OpenClaw 中使用 Venice](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [隐私模式](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [功能](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [设置](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [1\. 获取 API 密钥](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [2\. 配置 OpenClaw](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [3\. 验证设置](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [模型选择](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [通过 openclaw configure 配置](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [我应该使用哪个模型？](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [可用模型（共 41 个）](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [私密模型（26 个）—— 完全私密，不记录日志](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [匿名模型（15 个）—— 通过 Venice 代理](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [模型发现](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [流式传输与工具支持](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [定价](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [对比：Venice 与直接 API](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [使用示例](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [故障排除](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [API 密钥无法识别](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [模型不可用](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [连接问题](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [配置文件示例](https://docs.openclaw.ai/zh-CN/providers/venice)
-   [链接](https://docs.openclaw.ai/zh-CN/providers/venice)
...
**Venice** 是我们重点推荐的 Venice 设置，适用于隐私优先的推理，并可选择通过匿名访问专有模型。 Venice AI 提供注重隐私的 AI 推理，支持未审查模型，并可通过其匿名代理访问主要专有模型。所有推理默认都是私密的——不会使用你的数据进行训练，也不会记录日志。
...
当设置了 `VENICE_API_KEY` 时，OpenClaw 会自动从 Venice API 发现模型。如果 API 不可访问，则会回退到静态目录。 `/models` 端点是公开的（列出模型无需身份验证），但推理需要有效的 API 密钥。
...
[Synthetic](https://docs.openclaw.ai/zh-CN/providers/synthetic)[Vercel AI Gateway](https://docs.openclaw.ai/zh-CN/providers/vercel-ai-gateway)
