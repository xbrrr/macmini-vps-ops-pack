<!-- Source: https://docs.openclaw.ai/zh-CN/channels/group-messages -->
<!-- Title: 群组消息 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/channels/group-messages)
...
-   [群组消息（WhatsApp 网页渠道）](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [已实现的功能（2025-12-03）](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [配置示例（WhatsApp）](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [激活命令（仅所有者）](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [使用方法](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [测试/验证](https://docs.openclaw.ai/zh-CN/channels/group-messages)
-   [已知注意事项](https://docs.openclaw.ai/zh-CN/channels/group-messages)
...
-   上下文注入：**仅待处理**的群组消息（默认 50 条），即_未_触发运行的消息，会以 `[Chat messages since your last reply - for context]` 为前缀注入，触发行在 `[Current message - respond to this]` 下。已在会话中的消息不会重复注入。
...
[配对](https://docs.openclaw.ai/zh-CN/channels/pairing)[群组](https://docs.openclaw.ai/zh-CN/channels/groups)
