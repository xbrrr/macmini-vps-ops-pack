<!-- Source: https://docs.openclaw.ai/zh-CN/channels/nostr -->
<!-- Title: Nostr - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/channels/nostr)
...
-   [Nostr](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [安装（按需）](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [新手引导（推荐）](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [手动安装](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [非交互式设置](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [快速设置](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [配置参考](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [资料元数据](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [访问控制](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [私信策略](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [允许列表示例](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [密钥格式](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [中继](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [协议支持](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [测试](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [本地中继](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [手动测试](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [故障排除](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [未接收到消息](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [未发送回复](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [重复回复](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [安全性](https://docs.openclaw.ai/zh-CN/channels/nostr)
-   [限制（MVP）](https://docs.openclaw.ai/zh-CN/channels/nostr)
...
**状态：** 可选插件（默认禁用）。 Nostr 是一种用于社交网络的去中心化协议。此渠道使 OpenClaw 能够通过 NIP-04 接收并回复加密私信。
...
资料数据会作为 NIP-01 `kind:0` 事件发布。你可以在控制 UI 中管理它（Channels -> Nostr -> Profile），也可以直接在配置中设置。 示例：
...
[Nextcloud Talk](https://docs.openclaw.ai/zh-CN/channels/nextcloud-talk)[Signal](https://docs.openclaw.ai/zh-CN/channels/signal)
