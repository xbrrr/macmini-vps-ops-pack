<!-- Source: https://docs.openclaw.ai/zh-CN/channels/zalo -->
<!-- Title: Zalo - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/channels/zalo)
...
-   [Zalo (Bot API)](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [需要插件](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [快速设置（初学者）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [它是什么](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [设置（快速路径）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [1）创建 bot token（Zalo Bot 平台）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [2）配置 token（环境变量或配置）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [工作原理（行为）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [限制](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [访问控制（私信）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [私信访问](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [长轮询与 webhook](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [支持的消息类型](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [功能](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [投递目标（CLI/cron）](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [故障排除](https://docs.openclaw.ai/zh-CN/channels/zalo)
-   [配置参考（Zalo）](https://docs.openclaw.ai/zh-CN/channels/zalo)
...
Zalo 是一款专注于越南市场的即时通讯应用；其 Bot API 让 Gateway 网关可以运行一个用于一对一对话的 bot。 它非常适合需要确定性路由回 Zalo 的支持或通知场景。
...
环境变量选项：`ZALO_BOT_TOKEN=...`（仅适用于默认账户）。 多账户支持：使用 `channels.zalo.accounts` 配置每账户 token 和可选的 `name`。
...
-   配对是默认的令牌交换方式。详情：[配对](https://docs.openclaw.ai/channels/pairing)
...
[WhatsApp](https://docs.openclaw.ai/zh-CN/channels/whatsapp)[Zalo Personal](https://docs.openclaw.ai/zh-CN/channels/zalouser)
