<!-- Source: https://docs.openclaw.ai/zh-CN/channels/msteams -->
<!-- Title: Microsoft Teams - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/channels/msteams)
...
-   [Microsoft Teams（插件）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [需要插件](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [快速设置（初学者）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [目标](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [配置写入](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [访问控制（私信 + 群组）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [工作原理](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [Azure Bot 设置（前提条件）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [步骤 1：创建 Azure Bot](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [步骤 2：获取凭证](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [步骤 3：配置消息端点](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [步骤 4：启用 Teams 渠道](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [本地开发（隧道）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [Teams 开发者门户（替代方案）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [测试机器人](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [设置（最小纯文本）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [历史上下文](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [当前 Teams RSC 权限（清单）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [Teams 清单示例（已脱敏）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [清单注意事项（必填字段）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [更新现有应用](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [功能：仅 RSC 与 Graph](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [仅使用 Teams RSC（应用已安装，无 Graph API 权限）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [使用 Teams RSC + Microsoft Graph Application 权限](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [RSC 与 Graph API 对比](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [启用 Graph 的媒体 + 历史（频道所需）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [已知限制](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [Webhook 超时](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [格式化](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [配置](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [路由和会话](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [回复样式：话题 vs 帖子](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [附件和图片](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [在群聊中发送文件](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [为什么群聊需要 SharePoint](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [设置](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [共享行为](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [回退行为](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [文件存储位置](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [投票（Adaptive Cards）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [Adaptive Cards（任意）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [目标格式](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [主动消息](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [团队和频道 ID（常见陷阱）](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [私有频道](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [故障排除](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [常见问题](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [清单上传错误](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [RSC 权限不工作](https://docs.openclaw.ai/zh-CN/channels/msteams)
-   [参考资料](https://docs.openclaw.ai/zh-CN/channels/msteams)
...
更新时间：2026-01-21 状态：支持文本 + 私信附件；频道/群组文件发送需要 `sharePointSiteId` + Graph 权限（参见[在群聊中发送文件](https://docs.openclaw.ai/zh-CN/channels/msteams)）。投票通过 Adaptive Cards 发送。
...
Microsoft Teams 作为插件提供，不包含在核心安装中。 **破坏性变更（2026.1.15）：** MS Teams 已从核心移出。如果你使用它，必须安装插件。 原因说明：保持核心安装更轻量，并让 MS Teams 依赖项可以独立更新。 通过 CLI 安装（npm 注册表）：
...
如果你在配置/新手引导过程中选择 Teams 并检测到 git 检出， OpenClaw 将自动提供本地安装路径。 详情：[插件](https://docs.openclaw.ai/tools/plugin)
...
1.  前往[创建 Azure Bot](https://portal.azure.com/)
2.  填写**基本信息**选项卡：
...
2.  将 **Messaging endpoint** 设置为你的 webhook URL：
    ...
    -   本地开发：使用隧道（见下方[本地开发](https://docs.openclaw.ai/zh-CN/channels/msteams)）
...
Teams 无法访问 `localhost`。本地开发请使用隧道： **选项 A：ngrok**
...
这些是我们 Teams 应用清单中**现有的 resourceSpecific 权限**。它们仅适用于安装了应用的团队/聊天内部。 **对于频道（团队范围）：**
...
-   `channels.msteams.replyStyle`：`thread | top-level`（见[回复样式](https://docs.openclaw.ai/zh-CN/channels/msteams)）。
...
-   `channels.msteams.sharePointSiteId`：用于群聊/频道文件上传的 SharePoint 站点 ID（见[在群聊中发送文件](https://docs.openclaw.ai/zh-CN/channels/msteams)）。
...
-   会话键遵循标准智能体格式（见 [/concepts/session](https://docs.openclaw.ai/concepts/session)）：
...
没有 Graph 权限，带图片的频道消息将作为纯文本接收（机器人无法访问图片内容）。 默认情况下，OpenClaw 仅从 Microsoft/Teams 主机名下载媒体。使用 `channels.msteams.mediaAllowHosts` 覆盖（使用 `["*"]` 允许任何主机）。 Authorization 头仅附加到 `channels.msteams.mediaAuthAllowHosts` 中的主机（默认为 Graph + Bot Framework 主机）。保持此列表严格（避免多租户后缀）。
...
使用 `message` 工具或 CLI 向 Teams 用户或会话发送任意 Adaptive Card JSON。 `card` 参数接受 Adaptive Card JSON 对象。当提供 `card` 时，消息文本是可选的。 **智能体工具：**
...
参见 [Adaptive Cards 文档](https://adaptivecards.io/)了解卡片模式和示例。目标格式详情见下方[目标格式](https://docs.openclaw.ai/zh-CN/channels/msteams)。
...
-   **上传时”Something went wrong”：** 改为通过 [https://admin.teams.microsoft.com](https://admin.teams.microsoft.com/) 上传，打开浏览器 DevTools（F12）→ Network 选项卡，检查响应正文中的实际错误。
...
[Mattermost](https://docs.openclaw.ai/zh-CN/channels/mattermost)[Nextcloud Talk](https://docs.openclaw.ai/zh-CN/channels/nextcloud-talk)
