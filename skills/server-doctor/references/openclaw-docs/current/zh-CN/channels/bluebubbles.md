<!-- Source: https://docs.openclaw.ai/zh-CN/channels/bluebubbles -->
<!-- Title: BlueBubbles - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
...
-   [BlueBubbles（macOS REST）](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [概览](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [快速开始](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [保持 Messages.app 处于活动状态（VM / 无头设置）](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [1）保存 AppleScript](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [2）安装 LaunchAgent](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [新手引导](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [访问控制（私信 + 群组）](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [提及门控（群组）](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [命令门控](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [输入状态 + 已读回执](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [高级操作](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [消息 ID（短 ID 与完整 ID）](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [分块流式传输](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [媒体 + 限制](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [配置参考](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [寻址 / 送达目标](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [安全](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
-   [故障排除](https://docs.openclaw.ai/zh-CN/channels/bluebubbles)
...
-   配对是默认的令牌交换方式。详情见：[配对](https://docs.openclaw.ai/channels/pairing)
...
模板变量请参见[配置](https://docs.openclaw.ai/gateway/configuration)。
...
-   对 localhost 的信任意味着同主机上的反向代理可能会无意中绕过密码。如果你对 Gateway 网关进行了代理，请在代理层要求身份验证，并配置 `gateway.trustedProxies`。请参见 [Gateway 网关安全](https://docs.openclaw.ai/gateway/security)。
...
有关通用渠道工作流程参考，请参见 [Channels](https://docs.openclaw.ai/channels) 和 [Plugins](https://docs.openclaw.ai/tools/plugin) 指南。

[聊天渠道](https://docs.openclaw.ai/zh-CN/channels)[Discord](https://docs.openclaw.ai/zh-CN/channels/discord)
