<!-- Source: https://docs.openclaw.ai/zh-CN/tools -->
<!-- Title: 工具 - OpenClaw -->

[跳转到主要内容](https://docs.openclaw.ai/zh-CN/tools)
...
-   [工具（OpenClaw）](https://docs.openclaw.ai/zh-CN/tools)
-   [禁用工具](https://docs.openclaw.ai/zh-CN/tools)
-   [工具配置文件（基础允许列表）](https://docs.openclaw.ai/zh-CN/tools)
-   [特定提供商的工具策略](https://docs.openclaw.ai/zh-CN/tools)
-   [工具组（简写）](https://docs.openclaw.ai/zh-CN/tools)
-   [插件 + 工具](https://docs.openclaw.ai/zh-CN/tools)
-   [工具清单](https://docs.openclaw.ai/zh-CN/tools)
-   [apply\_patch](https://docs.openclaw.ai/zh-CN/tools)
-   [exec](https://docs.openclaw.ai/zh-CN/tools)
-   [process](https://docs.openclaw.ai/zh-CN/tools)
-   [web\_search](https://docs.openclaw.ai/zh-CN/tools)
-   [web\_fetch](https://docs.openclaw.ai/zh-CN/tools)
-   [browser](https://docs.openclaw.ai/zh-CN/tools)
-   [canvas](https://docs.openclaw.ai/zh-CN/tools)
-   [nodes](https://docs.openclaw.ai/zh-CN/tools)
-   [image](https://docs.openclaw.ai/zh-CN/tools)
-   [message](https://docs.openclaw.ai/zh-CN/tools)
-   [cron](https://docs.openclaw.ai/zh-CN/tools)
-   [gateway](https://docs.openclaw.ai/zh-CN/tools)
-   [sessions\_list / sessions\_history / sessions\_send / sessions\_spawn / session\_status](https://docs.openclaw.ai/zh-CN/tools)
-   [agents\_list](https://docs.openclaw.ai/zh-CN/tools)
-   [参数（通用）](https://docs.openclaw.ai/zh-CN/tools)
-   [推荐的智能体流程](https://docs.openclaw.ai/zh-CN/tools)
-   [安全性](https://docs.openclaw.ai/zh-CN/tools)
-   [工具如何呈现给智能体](https://docs.openclaw.ai/zh-CN/tools)
...
OpenClaw 为 browser、canvas、nodes 和 cron 暴露**一流的智能体工具**。 这些工具取代了旧的 `openclaw-*` Skills：工具是类型化的，无需调用 shell， 智能体应该直接依赖它们。
...
`tools.profile` 在 `tools.allow`/`tools.deny` 之前设置**基础工具允许列表**。 按智能体覆盖：`agents.list[].tools.profile`。 配置文件：
...
使用 `tools.byProvider` 为特定提供商（或单个 `provider/model`）**进一步限制**工具， 而不更改你的全局默认值。 按智能体覆盖：`agents.list[].tools.byProvider`。 这在基础工具配置文件**之后**和允许/拒绝列表**之前**应用， 因此它只能缩小工具集。 提供商键接受 `provider`（例如 `google-antigravity`）或 `provider/model`（例如 `openai/gpt-5.2`）。 示例（保持全局 coding 配置文件，但 Google Antigravity 使用最小工具）：
...
插件可以在核心集之外注册**额外的工具**（和 CLI 命令）。 参见[插件](https://docs.openclaw.ai/tools/plugin)了解安装 + 配置，以及 [Skills](https://docs.openclaw.ai/tools/skills) 了解 工具使用指导如何被注入到提示中。一些插件随工具一起提供自己的 Skills （例如，voice-call 插件）。 可选的插件工具：

-   [Lobster](https://docs.openclaw.ai/tools/lobster)：带有可恢复审批的类型化工作流运行时（需要 Gateway 网关主机上的 Lobster CLI）。
-   [LLM Task](https://docs.openclaw.ai/tools/llm-task)：用于结构化工作流输出的 JSON-only LLM 步骤（可选 schema 验证）。
...
-   Gateway 网关/节点审批和允许列表：[执行审批](https://docs.openclaw.ai/tools/exec-approvals)。
...
-   响应被缓存（默认 15 分钟）。
-   参见 [Web 工具](https://docs.openclaw.ai/tools/web) 了解设置。
...
-   参见 [Web 工具](https://docs.openclaw.ai/tools/web) 了解设置。
-   参见 [Firecrawl](https://docs.openclaw.ai/tools/firecrawl) 了解可选的反机器人回退。
...
[apply\_patch 工具](https://docs.openclaw.ai/zh-CN/tools/apply-patch)
