...
[Skip to main content](https://docs.openclaw.ai/automation/cron-jobs)
...
-   [Cron jobs (Gateway scheduler)](https://docs.openclaw.ai/automation/cron-jobs)
-   [TL;DR](https://docs.openclaw.ai/automation/cron-jobs)
-   [Quick start (actionable)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Tool-call equivalents (Gateway cron tool)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Where cron jobs are stored](https://docs.openclaw.ai/automation/cron-jobs)
-   [Beginner-friendly overview](https://docs.openclaw.ai/automation/cron-jobs)
-   [Concepts](https://docs.openclaw.ai/automation/cron-jobs)
-   [Jobs](https://docs.openclaw.ai/automation/cron-jobs)
-   [Schedules](https://docs.openclaw.ai/automation/cron-jobs)
-   [Main vs isolated execution](https://docs.openclaw.ai/automation/cron-jobs)
-   [Main session jobs (system events)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Isolated jobs (dedicated cron sessions)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Payload shapes (what runs)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Announce delivery flow](https://docs.openclaw.ai/automation/cron-jobs)
-   [Webhook delivery flow](https://docs.openclaw.ai/automation/cron-jobs)
-   [Model and thinking overrides](https://docs.openclaw.ai/automation/cron-jobs)
-   [Lightweight bootstrap context](https://docs.openclaw.ai/automation/cron-jobs)
-   [Delivery (channel + target)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Telegram delivery targets (topics / forum threads)](https://docs.openclaw.ai/automation/cron-jobs)
-   [JSON schema for tool calls](https://docs.openclaw.ai/automation/cron-jobs)
-   [cron.add params](https://docs.openclaw.ai/automation/cron-jobs)
-   [cron.update params](https://docs.openclaw.ai/automation/cron-jobs)
-   [cron.run and cron.remove params](https://docs.openclaw.ai/automation/cron-jobs)
-   [Storage & history](https://docs.openclaw.ai/automation/cron-jobs)
-   [Retry policy](https://docs.openclaw.ai/automation/cron-jobs)
-   [Transient errors (retried)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Permanent errors (no retry)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Default behavior (no config)](https://docs.openclaw.ai/automation/cron-jobs)
-   [Configuration](https://docs.openclaw.ai/automation/cron-jobs)
-   [Maintenance](https://docs.openclaw.ai/automation/cron-jobs)
-   [Defaults](https://docs.openclaw.ai/automation/cron-jobs)
-   [How it works](https://docs.openclaw.ai/automation/cron-jobs)
-   [Performance caveat for high volume schedulers](https://docs.openclaw.ai/automation/cron-jobs)
-   [Customize examples](https://docs.openclaw.ai/automation/cron-jobs)
-   [CLI quickstart](https://docs.openclaw.ai/automation/cron-jobs)
-   [Gateway API surface](https://docs.openclaw.ai/automation/cron-jobs)
-   [Troubleshooting](https://docs.openclaw.ai/automation/cron-jobs)
-   [“Nothing runs”](https://docs.openclaw.ai/automation/cron-jobs)
-   [A recurring job keeps delaying after failures](https://docs.openclaw.ai/automation/cron-jobs)
-   [Telegram delivers to the wrong place](https://docs.openclaw.ai/automation/cron-jobs)
-   [Subagent announce delivery retries](https://docs.openclaw.ai/automation/cron-jobs)
...
For the canonical JSON shapes and examples, see [JSON schema for tool calls](https://docs.openclaw.ai/automation/cron-jobs).
...
Configure `cron.retry` to override these defaults (see [Configuration](https://docs.openclaw.ai/automation/cron-jobs)).
...
-   One-shot (`at`) jobs retry transient errors (rate limit, overloaded, network, server\_error) up to 3 times with backoff; permanent errors disable immediately. See [Retry policy](https://docs.openclaw.ai/automation/cron-jobs).
