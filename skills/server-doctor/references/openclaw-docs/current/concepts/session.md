...
[Skip to main content](https://docs.openclaw.ai/concepts/session)
...
-   [Secure DM mode (recommended for multi-user setups)](https://docs.openclaw.ai/concepts/session)
-   [Gateway is the source of truth](https://docs.openclaw.ai/concepts/session)
-   [Where state lives](https://docs.openclaw.ai/concepts/session)
-   [Maintenance](https://docs.openclaw.ai/concepts/session)
-   [Defaults](https://docs.openclaw.ai/concepts/session)
-   [How it works](https://docs.openclaw.ai/concepts/session)
-   [Performance caveat for large stores](https://docs.openclaw.ai/concepts/session)
-   [Customize examples](https://docs.openclaw.ai/concepts/session)
-   [Session pruning](https://docs.openclaw.ai/concepts/session)
-   [Pre-compaction memory flush](https://docs.openclaw.ai/concepts/session)
-   [Mapping transports → session keys](https://docs.openclaw.ai/concepts/session)
-   [Lifecycle](https://docs.openclaw.ai/concepts/session)
-   [Send policy (optional)](https://docs.openclaw.ai/concepts/session)
-   [Configuration (optional rename example)](https://docs.openclaw.ai/concepts/session)
-   [Inspecting](https://docs.openclaw.ai/concepts/session)
-   [Tips](https://docs.openclaw.ai/concepts/session)
-   [Session origin metadata](https://docs.openclaw.ai/concepts/session)
...
[Bootstrapping](https://docs.openclaw.ai/start/bootstrapping)[Session Pruning](https://docs.openclaw.ai/concepts/session-pruning)
