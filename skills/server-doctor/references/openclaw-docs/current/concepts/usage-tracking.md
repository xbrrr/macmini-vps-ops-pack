...
[Skip to main content](https://docs.openclaw.ai/concepts/usage-tracking)
...
-   [What it is](https://docs.openclaw.ai/concepts/usage-tracking)
-   [Where it shows up](https://docs.openclaw.ai/concepts/usage-tracking)
-   [Providers + credentials](https://docs.openclaw.ai/concepts/usage-tracking)
