...
<!-- Title: Timezones - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/concepts/timezone)
...
-   [Message envelopes (local by default)](https://docs.openclaw.ai/concepts/timezone)
-   [Examples](https://docs.openclaw.ai/concepts/timezone)
-   [Tool payloads (raw provider data + normalized fields)](https://docs.openclaw.ai/concepts/timezone)
-   [User timezone for the system prompt](https://docs.openclaw.ai/concepts/timezone)
...
[Usage Tracking](https://docs.openclaw.ai/concepts/usage-tracking)[Credits](https://docs.openclaw.ai/reference/credits)
