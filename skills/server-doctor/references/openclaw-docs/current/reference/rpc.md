...
<!-- Title: RPC Adapters - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/reference/rpc)
...
-   [Pattern A: HTTP daemon (signal-cli)](https://docs.openclaw.ai/reference/rpc)
-   [Pattern B: stdio child process (legacy: imsg)](https://docs.openclaw.ai/reference/rpc)
-   [Adapter guidelines](https://docs.openclaw.ai/reference/rpc)
