...
[Skip to main content](https://docs.openclaw.ai/reference/templates/USER)
...
-   [Context](https://docs.openclaw.ai/reference/templates/USER)
...
[TOOLS.md Template](https://docs.openclaw.ai/reference/templates/TOOLS)[Wizard Reference](https://docs.openclaw.ai/reference/wizard)
