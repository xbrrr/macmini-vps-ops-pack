...
<!-- Title: TOOLS.md Template - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/reference/templates/TOOLS)
...
-   [What Goes Here](https://docs.openclaw.ai/reference/templates/TOOLS)
-   [Examples](https://docs.openclaw.ai/reference/templates/TOOLS)
-   [Why Separate?](https://docs.openclaw.ai/reference/templates/TOOLS)
