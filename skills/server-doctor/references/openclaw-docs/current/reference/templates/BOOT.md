...
<!-- Title: BOOT.md Template - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/reference/templates/BOOT)
...
[AGENTS.md Template](https://docs.openclaw.ai/reference/templates/AGENTS)[BOOTSTRAP.md Template](https://docs.openclaw.ai/reference/templates/BOOTSTRAP)
