...
[Skip to main content](https://docs.openclaw.ai/gateway/doctor)
...
-   [Quick start](https://docs.openclaw.ai/gateway/doctor)
-   [Headless / automation](https://docs.openclaw.ai/gateway/doctor)
-   [What it does (summary)](https://docs.openclaw.ai/gateway/doctor)
-   [Detailed behavior and rationale](https://docs.openclaw.ai/gateway/doctor)
-   [0) Optional update (git installs)](https://docs.openclaw.ai/gateway/doctor)
-   [1) Config normalization](https://docs.openclaw.ai/gateway/doctor)
-   [2) Legacy config key migrations](https://docs.openclaw.ai/gateway/doctor)
-   [2b) OpenCode provider overrides](https://docs.openclaw.ai/gateway/doctor)
-   [2c) Browser migration and Chrome MCP readiness](https://docs.openclaw.ai/gateway/doctor)
-   [3) Legacy state migrations (disk layout)](https://docs.openclaw.ai/gateway/doctor)
-   [3b) Legacy cron store migrations](https://docs.openclaw.ai/gateway/doctor)
-   [4) State integrity checks (session persistence, routing, and safety)](https://docs.openclaw.ai/gateway/doctor)
-   [5) Model auth health (OAuth expiry)](https://docs.openclaw.ai/gateway/doctor)
-   [6) Hooks model validation](https://docs.openclaw.ai/gateway/doctor)
-   [7) Sandbox image repair](https://docs.openclaw.ai/gateway/doctor)
-   [8) Gateway service migrations and cleanup hints](https://docs.openclaw.ai/gateway/doctor)
-   [9) Security warnings](https://docs.openclaw.ai/gateway/doctor)
-   [10) systemd linger (Linux)](https://docs.openclaw.ai/gateway/doctor)
-   [11) Skills status](https://docs.openclaw.ai/gateway/doctor)
-   [12) Gateway auth checks (local token)](https://docs.openclaw.ai/gateway/doctor)
-   [12b) Read-only SecretRef-aware repairs](https://docs.openclaw.ai/gateway/doctor)
-   [13) Gateway health check + restart](https://docs.openclaw.ai/gateway/doctor)
-   [14) Channel status warnings](https://docs.openclaw.ai/gateway/doctor)
-   [15) Supervisor config audit + repair](https://docs.openclaw.ai/gateway/doctor)
-   [16) Gateway runtime + port diagnostics](https://docs.openclaw.ai/gateway/doctor)
-   [17) Gateway runtime best practices](https://docs.openclaw.ai/gateway/doctor)
-   [18) Config write + wizard metadata](https://docs.openclaw.ai/gateway/doctor)
-   [19) Workspace tips (backup + memory system)](https://docs.openclaw.ai/gateway/doctor)
...
[Heartbeat](https://docs.openclaw.ai/gateway/heartbeat)[Logging](https://docs.openclaw.ai/gateway/logging)
