...
<!-- Title: Sandboxing - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/gateway/sandboxing)
...
-   [What gets sandboxed](https://docs.openclaw.ai/gateway/sandboxing)
-   [Modes](https://docs.openclaw.ai/gateway/sandboxing)
-   [Scope](https://docs.openclaw.ai/gateway/sandboxing)
-   [Backend](https://docs.openclaw.ai/gateway/sandboxing)
-   [SSH backend](https://docs.openclaw.ai/gateway/sandboxing)
-   [OpenShell workspace modes](https://docs.openclaw.ai/gateway/sandboxing)
-   [mirror](https://docs.openclaw.ai/gateway/sandboxing)
-   [remote](https://docs.openclaw.ai/gateway/sandboxing)
-   [OpenShell lifecycle](https://docs.openclaw.ai/gateway/sandboxing)
-   [Workspace access](https://docs.openclaw.ai/gateway/sandboxing)
-   [Custom bind mounts](https://docs.openclaw.ai/gateway/sandboxing)
-   [Images + setup](https://docs.openclaw.ai/gateway/sandboxing)
-   [setupCommand (one-time container setup)](https://docs.openclaw.ai/gateway/sandboxing)
-   [Tool policy + escape hatches](https://docs.openclaw.ai/gateway/sandboxing)
-   [Multi-agent overrides](https://docs.openclaw.ai/gateway/sandboxing)
-   [Minimal enable example](https://docs.openclaw.ai/gateway/sandboxing)
-   [Related docs](https://docs.openclaw.ai/gateway/sandboxing)
...
OpenShell reuses the same core SSH transport and remote filesystem bridge as the generic SSH backend. The plugin adds OpenShell-specific lifecycle (`sandbox create/get/delete`, `sandbox ssh-config`) and the optional `mirror` mode. Remote transport details:
