...
<!-- Title: Model Config Exploration - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/experiments/proposals/model-config)
...
-   [Model Config (Exploration)](https://docs.openclaw.ai/experiments/proposals/model-config)
-   [Motivation](https://docs.openclaw.ai/experiments/proposals/model-config)
-   [Possible direction (high level)](https://docs.openclaw.ai/experiments/proposals/model-config)
-   [Open questions](https://docs.openclaw.ai/experiments/proposals/model-config)
