...
<!-- Title: ACP Thread Bound Agents - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
...
-   [ACP Thread Bound Agents](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Overview](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Decision summary](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [North-star architecture (holy grail)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Delivery strategy (bridge to holy-grail)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Why not pure plugin only](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Existing foundation to reuse](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Architecture](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Boundary model](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Runtime ownership model](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Core runtime contract](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Control-plane data model and persistence](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Routing and delivery](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [State machines and transaction boundaries](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Per-session actor model](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Idempotency and delivery projection](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Recovery and self-healing](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Lifecycle and safety](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Config surface](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Implementation specification](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Control-plane modules (new)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Required invariants (must enforce in code)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Core touchpoints](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [ACP runtime registry API](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [acpx runtime plugin contract (implementation detail)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Session schema patch](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Error contract](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Duplicate delivery arbitration](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Observability and operational readiness](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Config precedence and effective values](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Test map](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Rollout guard](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Command and UX plan](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [New commands](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Existing command compatibility](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phased rollout](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 0 ADR and schema freeze](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 1 Control-plane foundation in core](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 2 Core routing and lifecycle integration](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 3 acpx backend adapter/plugin](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 4 Delivery projection and channel UX (Discord first)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 5 Migration and cutover](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Phase 6 Hardening, SLOs, and scale limits](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Full implementation checklist](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Test plan](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Risks and mitigations](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Acceptance checklist](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [Addendum: targeted refactors for current implementation (status)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [1) Centralize ACP dispatch policy evaluation (completed)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [2) Split ACP command handler by subcommand domain (completed)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [3) Split ACP session manager by responsibility (completed)](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
-   [4) Optional acpx runtime adapter cleanup](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
...
[Onboarding and Config Protocol](https://docs.openclaw.ai/experiments/onboarding-config-protocol)[Unified Runtime Streaming Refactor Plan](https://docs.openclaw.ai/experiments/plans/acp-unified-streaming-refactor)
