...
<!-- Title: Onboarding and Config Protocol - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
...
-   [Onboarding + Config Protocol](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
-   [Components](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
-   [Gateway RPC](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
-   [UI Hints](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
-   [Notes](https://docs.openclaw.ai/experiments/onboarding-config-protocol)
...
[Kilo gateway integration](https://docs.openclaw.ai/design/kilo-gateway-integration)[ACP Thread Bound Agents](https://docs.openclaw.ai/experiments/plans/acp-thread-bound-agents)
