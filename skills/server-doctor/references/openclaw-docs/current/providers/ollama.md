...
[Skip to main content](https://docs.openclaw.ai/providers/ollama)
...
-   [Quick start](https://docs.openclaw.ai/providers/ollama)
-   [Onboarding wizard (recommended)](https://docs.openclaw.ai/providers/ollama)
-   [Manual setup](https://docs.openclaw.ai/providers/ollama)
-   [Model discovery (implicit provider)](https://docs.openclaw.ai/providers/ollama)
-   [Configuration](https://docs.openclaw.ai/providers/ollama)
-   [Basic setup (implicit discovery)](https://docs.openclaw.ai/providers/ollama)
-   [Explicit setup (manual models)](https://docs.openclaw.ai/providers/ollama)
-   [Custom base URL (explicit config)](https://docs.openclaw.ai/providers/ollama)
-   [Model selection](https://docs.openclaw.ai/providers/ollama)
-   [Cloud models](https://docs.openclaw.ai/providers/ollama)
-   [Advanced](https://docs.openclaw.ai/providers/ollama)
-   [Reasoning models](https://docs.openclaw.ai/providers/ollama)
-   [Model Costs](https://docs.openclaw.ai/providers/ollama)
-   [Streaming Configuration](https://docs.openclaw.ai/providers/ollama)
-   [Legacy OpenAI-Compatible Mode](https://docs.openclaw.ai/providers/ollama)
-   [Context windows](https://docs.openclaw.ai/providers/ollama)
-   [Troubleshooting](https://docs.openclaw.ai/providers/ollama)
-   [Ollama not detected](https://docs.openclaw.ai/providers/ollama)
-   [No models available](https://docs.openclaw.ai/providers/ollama)
-   [Connection refused](https://docs.openclaw.ai/providers/ollama)
-   [See Also](https://docs.openclaw.ai/providers/ollama)
