...
[Skip to main content](https://docs.openclaw.ai/providers/nvidia)
...
-   [CLI setup](https://docs.openclaw.ai/providers/nvidia)
-   [Config snippet](https://docs.openclaw.ai/providers/nvidia)
-   [Model IDs](https://docs.openclaw.ai/providers/nvidia)
-   [Notes](https://docs.openclaw.ai/providers/nvidia)
...
[Mistral](https://docs.openclaw.ai/providers/mistral)[Ollama](https://docs.openclaw.ai/providers/ollama)
