...
[Skip to main content](https://docs.openclaw.ai/providers/synthetic)
...
-   [Quick setup](https://docs.openclaw.ai/providers/synthetic)
-   [Config example](https://docs.openclaw.ai/providers/synthetic)
-   [Model catalog](https://docs.openclaw.ai/providers/synthetic)
-   [Notes](https://docs.openclaw.ai/providers/synthetic)
...
[Qwen](https://docs.openclaw.ai/providers/qwen)[Together](https://docs.openclaw.ai/providers/together)
