...
[Skip to main content](https://docs.openclaw.ai/providers/openrouter)
...
-   [CLI setup](https://docs.openclaw.ai/providers/openrouter)
-   [Config snippet](https://docs.openclaw.ai/providers/openrouter)
-   [Notes](https://docs.openclaw.ai/providers/openrouter)
...
[OpenCode](https://docs.openclaw.ai/providers/opencode)[Qianfan](https://docs.openclaw.ai/providers/qianfan)
