...
[Skip to main content](https://docs.openclaw.ai/providers/zai)
...
-   [CLI setup](https://docs.openclaw.ai/providers/zai)
-   [Config snippet](https://docs.openclaw.ai/providers/zai)
-   [Notes](https://docs.openclaw.ai/providers/zai)
