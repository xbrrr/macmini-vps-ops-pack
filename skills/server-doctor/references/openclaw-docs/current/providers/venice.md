...
[Skip to main content](https://docs.openclaw.ai/providers/venice)
...
-   [Venice AI (Venice highlight)](https://docs.openclaw.ai/providers/venice)
-   [Why Venice in OpenClaw](https://docs.openclaw.ai/providers/venice)
-   [Privacy Modes](https://docs.openclaw.ai/providers/venice)
-   [Features](https://docs.openclaw.ai/providers/venice)
-   [Setup](https://docs.openclaw.ai/providers/venice)
-   [1\. Get API Key](https://docs.openclaw.ai/providers/venice)
-   [2\. Configure OpenClaw](https://docs.openclaw.ai/providers/venice)
-   [3\. Verify Setup](https://docs.openclaw.ai/providers/venice)
-   [Model Selection](https://docs.openclaw.ai/providers/venice)
-   [Configure via openclaw configure](https://docs.openclaw.ai/providers/venice)
-   [Which Model Should I Use?](https://docs.openclaw.ai/providers/venice)
-   [Available Models (41 Total)](https://docs.openclaw.ai/providers/venice)
-   [Private Models (26) — Fully Private, No Logging](https://docs.openclaw.ai/providers/venice)
-   [Anonymized Models (15) — Via Venice Proxy](https://docs.openclaw.ai/providers/venice)
-   [Model Discovery](https://docs.openclaw.ai/providers/venice)
-   [Streaming & Tool Support](https://docs.openclaw.ai/providers/venice)
-   [Pricing](https://docs.openclaw.ai/providers/venice)
-   [Comparison: Venice vs Direct API](https://docs.openclaw.ai/providers/venice)
-   [Usage Examples](https://docs.openclaw.ai/providers/venice)
-   [Troubleshooting](https://docs.openclaw.ai/providers/venice)
-   [API key not recognized](https://docs.openclaw.ai/providers/venice)
-   [Model not available](https://docs.openclaw.ai/providers/venice)
-   [Connection issues](https://docs.openclaw.ai/providers/venice)
-   [Config file example](https://docs.openclaw.ai/providers/venice)
-   [Links](https://docs.openclaw.ai/providers/venice)
...
[Vercel AI Gateway](https://docs.openclaw.ai/providers/vercel-ai-gateway)[vLLM](https://docs.openclaw.ai/providers/vllm)
