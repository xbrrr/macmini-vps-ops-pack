...
[Skip to main content](https://docs.openclaw.ai/cli/doctor)
...
-   [Examples](https://docs.openclaw.ai/cli/doctor)
-   [macOS: launchctl env overrides](https://docs.openclaw.ai/cli/doctor)
...
[docs](https://docs.openclaw.ai/cli/docs)[gateway](https://docs.openclaw.ai/cli/gateway)
