...
[Skip to main content](https://docs.openclaw.ai/cli/config)
...
-   [Examples](https://docs.openclaw.ai/cli/config)
-   [Paths](https://docs.openclaw.ai/cli/config)
-   [Values](https://docs.openclaw.ai/cli/config)
-   [Subcommands](https://docs.openclaw.ai/cli/config)
-   [Validate](https://docs.openclaw.ai/cli/config)
...
[completion](https://docs.openclaw.ai/cli/completion)[configure](https://docs.openclaw.ai/cli/configure)
