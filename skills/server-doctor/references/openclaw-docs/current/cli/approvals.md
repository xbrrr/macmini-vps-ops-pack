...
[Skip to main content](https://docs.openclaw.ai/cli/approvals)
...
-   [Common commands](https://docs.openclaw.ai/cli/approvals)
-   [Replace approvals from a file](https://docs.openclaw.ai/cli/approvals)
-   [Allowlist helpers](https://docs.openclaw.ai/cli/approvals)
-   [Notes](https://docs.openclaw.ai/cli/approvals)
...
[agents](https://docs.openclaw.ai/cli/agents)[browser](https://docs.openclaw.ai/cli/browser)
