...
[Skip to main content](https://docs.openclaw.ai/cli/tui)
...
-   [Examples](https://docs.openclaw.ai/cli/tui)
...
[system](https://docs.openclaw.ai/cli/system)[uninstall](https://docs.openclaw.ai/cli/uninstall)
