...
[Skip to main content](https://docs.openclaw.ai/cli/system)
...
-   [Common commands](https://docs.openclaw.ai/cli/system)
-   [system event](https://docs.openclaw.ai/cli/system)
-   [system heartbeat last|enable|disable](https://docs.openclaw.ai/cli/system)
-   [system presence](https://docs.openclaw.ai/cli/system)
-   [Notes](https://docs.openclaw.ai/cli/system)
...
[status](https://docs.openclaw.ai/cli/status)[tui](https://docs.openclaw.ai/cli/tui)
