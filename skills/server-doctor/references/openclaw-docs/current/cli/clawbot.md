...
<!-- Title: clawbot - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/cli/clawbot)
...
-   [Migration](https://docs.openclaw.ai/cli/clawbot)
...
[channels](https://docs.openclaw.ai/cli/channels)[completion](https://docs.openclaw.ai/cli/completion)
