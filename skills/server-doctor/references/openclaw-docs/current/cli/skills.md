...
[Skip to main content](https://docs.openclaw.ai/cli/skills)
...
-   [Commands](https://docs.openclaw.ai/cli/skills)
...
[setup](https://docs.openclaw.ai/cli/setup)[status](https://docs.openclaw.ai/cli/status)
