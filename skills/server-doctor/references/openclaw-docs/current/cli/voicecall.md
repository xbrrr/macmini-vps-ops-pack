...
[Skip to main content](https://docs.openclaw.ai/cli/voicecall)
...
-   [Common commands](https://docs.openclaw.ai/cli/voicecall)
-   [Exposing webhooks (Tailscale)](https://docs.openclaw.ai/cli/voicecall)
...
[update](https://docs.openclaw.ai/cli/update)[webhooks](https://docs.openclaw.ai/cli/webhooks)
