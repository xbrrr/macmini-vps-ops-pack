...
[Skip to main content](https://docs.openclaw.ai/cli/pairing)
...
-   [Commands](https://docs.openclaw.ai/cli/pairing)
-   [Notes](https://docs.openclaw.ai/cli/pairing)
...
[onboard](https://docs.openclaw.ai/cli/onboard)[plugins](https://docs.openclaw.ai/cli/plugins)
