...
[Skip to main content](https://docs.openclaw.ai/cli/dns)
...
-   [Setup](https://docs.openclaw.ai/cli/dns)
...
[directory](https://docs.openclaw.ai/cli/directory)[docs](https://docs.openclaw.ai/cli/docs)
