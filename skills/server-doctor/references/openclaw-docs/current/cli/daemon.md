...
[Skip to main content](https://docs.openclaw.ai/cli/daemon)
...
-   [Usage](https://docs.openclaw.ai/cli/daemon)
-   [Subcommands](https://docs.openclaw.ai/cli/daemon)
-   [Common options](https://docs.openclaw.ai/cli/daemon)
-   [Prefer](https://docs.openclaw.ai/cli/daemon)
...
[cron](https://docs.openclaw.ai/cli/cron)[dashboard](https://docs.openclaw.ai/cli/dashboard)
