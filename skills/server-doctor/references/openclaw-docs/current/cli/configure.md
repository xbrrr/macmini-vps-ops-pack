...
[Skip to main content](https://docs.openclaw.ai/cli/configure)
...
-   [Examples](https://docs.openclaw.ai/cli/configure)
...
[config](https://docs.openclaw.ai/cli/config)[cron](https://docs.openclaw.ai/cli/cron)
