...
[Skip to main content](https://docs.openclaw.ai/channels/bluebubbles)
...
-   [BlueBubbles (macOS REST)](https://docs.openclaw.ai/channels/bluebubbles)
-   [Overview](https://docs.openclaw.ai/channels/bluebubbles)
-   [Quick start](https://docs.openclaw.ai/channels/bluebubbles)
-   [Keeping Messages.app alive (VM / headless setups)](https://docs.openclaw.ai/channels/bluebubbles)
-   [1) Save the AppleScript](https://docs.openclaw.ai/channels/bluebubbles)
-   [2) Install a LaunchAgent](https://docs.openclaw.ai/channels/bluebubbles)
-   [Onboarding](https://docs.openclaw.ai/channels/bluebubbles)
-   [Access control (DMs + groups)](https://docs.openclaw.ai/channels/bluebubbles)
-   [Mention gating (groups)](https://docs.openclaw.ai/channels/bluebubbles)
-   [Command gating](https://docs.openclaw.ai/channels/bluebubbles)
-   [Typing + read receipts](https://docs.openclaw.ai/channels/bluebubbles)
-   [Advanced actions](https://docs.openclaw.ai/channels/bluebubbles)
-   [Message IDs (short vs full)](https://docs.openclaw.ai/channels/bluebubbles)
-   [Block streaming](https://docs.openclaw.ai/channels/bluebubbles)
-   [Media + limits](https://docs.openclaw.ai/channels/bluebubbles)
-   [Configuration reference](https://docs.openclaw.ai/channels/bluebubbles)
-   [Addressing / delivery targets](https://docs.openclaw.ai/channels/bluebubbles)
-   [Security](https://docs.openclaw.ai/channels/bluebubbles)
-   [Troubleshooting](https://docs.openclaw.ai/channels/bluebubbles)
...
-   Localhost trust means a same-host reverse proxy can unintentionally bypass the password. If you proxy the gateway, require auth at the proxy and configure `gateway.trustedProxies`. See [Gateway security](https://docs.openclaw.ai/gateway/security).
