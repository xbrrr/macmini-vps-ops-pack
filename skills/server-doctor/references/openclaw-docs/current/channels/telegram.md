...
[Skip to main content](https://docs.openclaw.ai/channels/telegram)
...
-   [Telegram (Bot API)](https://docs.openclaw.ai/channels/telegram)
-   [Quick setup](https://docs.openclaw.ai/channels/telegram)
-   [Telegram side settings](https://docs.openclaw.ai/channels/telegram)
-   [Access control and activation](https://docs.openclaw.ai/channels/telegram)
-   [Runtime behavior](https://docs.openclaw.ai/channels/telegram)
-   [Feature reference](https://docs.openclaw.ai/channels/telegram)
-   [Troubleshooting](https://docs.openclaw.ai/channels/telegram)
-   [Telegram config reference pointers](https://docs.openclaw.ai/channels/telegram)
-   [Related](https://docs.openclaw.ai/channels/telegram)
...
More details: [Pairing](https://docs.openclaw.ai/channels/pairing).
...
Note: `edit` and `topic-create` are currently enabled by default and do not have separate `channels.telegram.actions.*` toggles. Runtime sends use the active config/secrets snapshot (startup/reload), so action paths do not perform ad-hoc SecretRef re-resolution per send.Reaction removal semantics: [/tools/reactions](https://docs.openclaw.ai/tools/reactions)
...
Telegram supports exec approvals in approver DMs and can optionally post approval prompts in the originating chat or topic.Config path:
...
Approvers must be numeric Telegram user IDs. When `enabled` is false or `approvers` is empty, Telegram does not act as an exec approval client. Approval requests fall back to other configured approval routes or the exec approval fallback policy.Delivery rules:
...
-   top-level `bindings[]` with `type: "acp"` and canonical topic id `chatId:topic:topicId` in `match.peer.id`: persistent ACP topic binding fields (see [ACP Agents](https://docs.openclaw.ai/tools/acp-agents)).
...
-   [Configuration reference - Telegram](https://docs.openclaw.ai/gateway/configuration-reference)
...
[Slack](https://docs.openclaw.ai/channels/slack)[Tlon](https://docs.openclaw.ai/channels/tlon)
