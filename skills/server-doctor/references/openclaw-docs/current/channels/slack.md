...
[Skip to main content](https://docs.openclaw.ai/channels/slack)
...
-   [Quick setup](https://docs.openclaw.ai/channels/slack)
-   [Token model](https://docs.openclaw.ai/channels/slack)
-   [Access control and routing](https://docs.openclaw.ai/channels/slack)
-   [Commands and slash behavior](https://docs.openclaw.ai/channels/slack)
-   [Interactive replies](https://docs.openclaw.ai/channels/slack)
-   [Threading, sessions, and reply tags](https://docs.openclaw.ai/channels/slack)
-   [Media, chunking, and delivery](https://docs.openclaw.ai/channels/slack)
-   [Actions and gates](https://docs.openclaw.ai/channels/slack)
-   [Events and operational behavior](https://docs.openclaw.ai/channels/slack)
-   [Ack reactions](https://docs.openclaw.ai/channels/slack)
-   [Typing reaction fallback](https://docs.openclaw.ai/channels/slack)
-   [Manifest and scope checklist](https://docs.openclaw.ai/channels/slack)
-   [Troubleshooting](https://docs.openclaw.ai/channels/slack)
-   [Text streaming](https://docs.openclaw.ai/channels/slack)
-   [Requirements](https://docs.openclaw.ai/channels/slack)
-   [Behavior](https://docs.openclaw.ai/channels/slack)
-   [Configuration reference pointers](https://docs.openclaw.ai/channels/slack)
-   [Related](https://docs.openclaw.ai/channels/slack)
...
Channel allowlist lives under `channels.slack.channels` and should use stable channel IDs.Runtime note: if `channels.slack` is completely missing (env-only setup), runtime falls back to `groupPolicy="allowlist"` and logs a warning (even if `channels.defaults.groupPolicy` is set).Name/ID resolution:
...
-   [Configuration reference - Slack](https://docs.openclaw.ai/gateway/configuration-reference) High-signal Slack fields:
...
[Synology Chat](https://docs.openclaw.ai/channels/synology-chat)[Telegram](https://docs.openclaw.ai/channels/telegram)
