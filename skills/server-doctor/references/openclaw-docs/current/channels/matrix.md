...
[Skip to main content](https://docs.openclaw.ai/channels/matrix)
...
-   [Matrix (plugin)](https://docs.openclaw.ai/channels/matrix)
-   [Plugin required](https://docs.openclaw.ai/channels/matrix)
-   [Setup](https://docs.openclaw.ai/channels/matrix)
-   [Encryption (E2EE)](https://docs.openclaw.ai/channels/matrix)
-   [Multi-account](https://docs.openclaw.ai/channels/matrix)
-   [Routing model](https://docs.openclaw.ai/channels/matrix)
-   [Access control (DMs)](https://docs.openclaw.ai/channels/matrix)
-   [Rooms (groups)](https://docs.openclaw.ai/channels/matrix)
-   [Threads](https://docs.openclaw.ai/channels/matrix)
-   [Capabilities](https://docs.openclaw.ai/channels/matrix)
-   [Troubleshooting](https://docs.openclaw.ai/channels/matrix)
-   [Configuration reference (Matrix)](https://docs.openclaw.ai/channels/matrix)
...
If you choose Matrix during setup and a git checkout is detected, OpenClaw will offer the local install path automatically. Details: [Plugins](https://docs.openclaw.ai/tools/plugin)
...
[LINE](https://docs.openclaw.ai/channels/line)[Mattermost](https://docs.openclaw.ai/channels/mattermost)
