...
[Skip to main content](https://docs.openclaw.ai/channels/mattermost)
...
-   [Plugin required](https://docs.openclaw.ai/channels/mattermost)
-   [Quick setup](https://docs.openclaw.ai/channels/mattermost)
-   [Native slash commands](https://docs.openclaw.ai/channels/mattermost)
-   [Environment variables (default account)](https://docs.openclaw.ai/channels/mattermost)
-   [Chat modes](https://docs.openclaw.ai/channels/mattermost)
-   [Threading and sessions](https://docs.openclaw.ai/channels/mattermost)
-   [Access control (DMs)](https://docs.openclaw.ai/channels/mattermost)
-   [Channels (groups)](https://docs.openclaw.ai/channels/mattermost)
-   [Targets for outbound delivery](https://docs.openclaw.ai/channels/mattermost)
-   [Reactions (message tool)](https://docs.openclaw.ai/channels/mattermost)
-   [Interactive buttons (message tool)](https://docs.openclaw.ai/channels/mattermost)
-   [Direct API integration (external scripts)](https://docs.openclaw.ai/channels/mattermost)
-   [Directory adapter](https://docs.openclaw.ai/channels/mattermost)
-   [Multi-account](https://docs.openclaw.ai/channels/mattermost)
-   [Troubleshooting](https://docs.openclaw.ai/channels/mattermost)
...
[Matrix](https://docs.openclaw.ai/channels/matrix)[Microsoft Teams](https://docs.openclaw.ai/channels/msteams)
