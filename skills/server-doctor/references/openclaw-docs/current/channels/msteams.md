...
[Skip to main content](https://docs.openclaw.ai/channels/msteams)
...
-   [Microsoft Teams (plugin)](https://docs.openclaw.ai/channels/msteams)
-   [Plugin required](https://docs.openclaw.ai/channels/msteams)
-   [Quick setup (beginner)](https://docs.openclaw.ai/channels/msteams)
-   [Goals](https://docs.openclaw.ai/channels/msteams)
-   [Config writes](https://docs.openclaw.ai/channels/msteams)
-   [Access control (DMs + groups)](https://docs.openclaw.ai/channels/msteams)
-   [How it works](https://docs.openclaw.ai/channels/msteams)
-   [Azure Bot Setup (Prerequisites)](https://docs.openclaw.ai/channels/msteams)
-   [Step 1: Create Azure Bot](https://docs.openclaw.ai/channels/msteams)
-   [Step 2: Get Credentials](https://docs.openclaw.ai/channels/msteams)
-   [Step 3: Configure Messaging Endpoint](https://docs.openclaw.ai/channels/msteams)
-   [Step 4: Enable Teams Channel](https://docs.openclaw.ai/channels/msteams)
-   [Local Development (Tunneling)](https://docs.openclaw.ai/channels/msteams)
-   [Teams Developer Portal (Alternative)](https://docs.openclaw.ai/channels/msteams)
-   [Testing the Bot](https://docs.openclaw.ai/channels/msteams)
-   [Setup (minimal text-only)](https://docs.openclaw.ai/channels/msteams)
-   [History context](https://docs.openclaw.ai/channels/msteams)
-   [Current Teams RSC Permissions (Manifest)](https://docs.openclaw.ai/channels/msteams)
-   [Example Teams Manifest (redacted)](https://docs.openclaw.ai/channels/msteams)
-   [Manifest caveats (must-have fields)](https://docs.openclaw.ai/channels/msteams)
-   [Updating an existing app](https://docs.openclaw.ai/channels/msteams)
-   [Capabilities: RSC only vs Graph](https://docs.openclaw.ai/channels/msteams)
-   [With Teams RSC only (app installed, no Graph API permissions)](https://docs.openclaw.ai/channels/msteams)
-   [With Teams RSC + Microsoft Graph Application permissions](https://docs.openclaw.ai/channels/msteams)
-   [RSC vs Graph API](https://docs.openclaw.ai/channels/msteams)
-   [Graph-enabled media + history (required for channels)](https://docs.openclaw.ai/channels/msteams)
-   [Known Limitations](https://docs.openclaw.ai/channels/msteams)
-   [Webhook timeouts](https://docs.openclaw.ai/channels/msteams)
-   [Formatting](https://docs.openclaw.ai/channels/msteams)
-   [Configuration](https://docs.openclaw.ai/channels/msteams)
-   [Routing & Sessions](https://docs.openclaw.ai/channels/msteams)
-   [Reply Style: Threads vs Posts](https://docs.openclaw.ai/channels/msteams)
-   [Attachments & Images](https://docs.openclaw.ai/channels/msteams)
-   [Sending files in group chats](https://docs.openclaw.ai/channels/msteams)
-   [Why group chats need SharePoint](https://docs.openclaw.ai/channels/msteams)
-   [Setup](https://docs.openclaw.ai/channels/msteams)
-   [Sharing behavior](https://docs.openclaw.ai/channels/msteams)
-   [Fallback behavior](https://docs.openclaw.ai/channels/msteams)
-   [Files stored location](https://docs.openclaw.ai/channels/msteams)
-   [Polls (Adaptive Cards)](https://docs.openclaw.ai/channels/msteams)
-   [Adaptive Cards (arbitrary)](https://docs.openclaw.ai/channels/msteams)
-   [Target formats](https://docs.openclaw.ai/channels/msteams)
-   [Proactive messaging](https://docs.openclaw.ai/channels/msteams)
-   [Team and Channel IDs (Common Gotcha)](https://docs.openclaw.ai/channels/msteams)
-   [Private Channels](https://docs.openclaw.ai/channels/msteams)
-   [Troubleshooting](https://docs.openclaw.ai/channels/msteams)
-   [Common issues](https://docs.openclaw.ai/channels/msteams)
-   [Manifest upload errors](https://docs.openclaw.ai/channels/msteams)
-   [RSC permissions not working](https://docs.openclaw.ai/channels/msteams)
-   [References](https://docs.openclaw.ai/channels/msteams)
...
Updated: 2026-01-21 Status: text + DM attachments are supported; channel/group file sending requires `sharePointSiteId` + Graph permissions (see [Sending files in group chats](https://docs.openclaw.ai/channels/msteams)). Polls are sent via Adaptive Cards.
...
-   On startup, OpenClaw resolves team/channel and user allowlist names to IDs (when Graph permissions allow) and logs the mapping; unresolved team/channel names are kept as typed but ignored for routing by default unless `channels.msteams.dangerouslyAllowNameMatching: true` is enabled.
...
1.  Go to [Create Azure Bot](https://portal.azure.com/)
...
2.  Set **Messaging endpoint** to your webhook URL:
    ...
    -   Local dev: Use a tunnel (see [Local Development](https://docs.openclaw.ai/channels/msteams) below)
...
-   `channels.msteams.replyStyle`: `thread | top-level` (see [Reply Style](https://docs.openclaw.ai/channels/msteams)).
...
-   `channels.msteams.sharePointSiteId`: SharePoint site ID for file uploads in group chats/channels (see [Sending files in group chats](https://docs.openclaw.ai/channels/msteams)).
...
See [Adaptive Cards documentation](https://adaptivecards.io/) for card schema and examples. For target format details, see [Target formats](https://docs.openclaw.ai/channels/msteams) below.
...
[Mattermost](https://docs.openclaw.ai/channels/mattermost)[Nextcloud Talk](https://docs.openclaw.ai/channels/nextcloud-talk)
