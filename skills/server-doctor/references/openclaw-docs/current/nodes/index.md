...
[Skip to main content](https://docs.openclaw.ai/nodes/index)
...
-   [Pairing + status](https://docs.openclaw.ai/nodes/index)
-   [Remote node host (system.run)](https://docs.openclaw.ai/nodes/index)
-   [What runs where](https://docs.openclaw.ai/nodes/index)
-   [Start a node host (foreground)](https://docs.openclaw.ai/nodes/index)
-   [Remote gateway via SSH tunnel (loopback bind)](https://docs.openclaw.ai/nodes/index)
-   [Start a node host (service)](https://docs.openclaw.ai/nodes/index)
-   [Pair + name](https://docs.openclaw.ai/nodes/index)
-   [Allowlist the commands](https://docs.openclaw.ai/nodes/index)
-   [Point exec at the node](https://docs.openclaw.ai/nodes/index)
-   [Invoking commands](https://docs.openclaw.ai/nodes/index)
-   [Screenshots (canvas snapshots)](https://docs.openclaw.ai/nodes/index)
-   [Canvas controls](https://docs.openclaw.ai/nodes/index)
-   [A2UI (Canvas)](https://docs.openclaw.ai/nodes/index)
-   [Photos + videos (node camera)](https://docs.openclaw.ai/nodes/index)
-   [Screen recordings (nodes)](https://docs.openclaw.ai/nodes/index)
-   [Location (nodes)](https://docs.openclaw.ai/nodes/index)
-   [SMS (Android nodes)](https://docs.openclaw.ai/nodes/index)
-   [Android device + personal data commands](https://docs.openclaw.ai/nodes/index)
-   [System commands (node host / mac node)](https://docs.openclaw.ai/nodes/index)
-   [Exec node binding](https://docs.openclaw.ai/nodes/index)
-   [Permissions map](https://docs.openclaw.ai/nodes/index)
-   [Headless node host (cross-platform)](https://docs.openclaw.ai/nodes/index)
-   [Mac node mode](https://docs.openclaw.ai/nodes/index)
...
[Auth Monitoring](https://docs.openclaw.ai/automation/auth-monitoring)[Node Troubleshooting](https://docs.openclaw.ai/nodes/troubleshooting)
