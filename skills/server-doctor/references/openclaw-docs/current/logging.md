...
[Skip to main content](https://docs.openclaw.ai/logging)
...
-   [Where logs live](https://docs.openclaw.ai/logging)
-   [How to read logs](https://docs.openclaw.ai/logging)
-   [CLI: live tail (recommended)](https://docs.openclaw.ai/logging)
-   [Control UI (web)](https://docs.openclaw.ai/logging)
-   [Channel-only logs](https://docs.openclaw.ai/logging)
-   [Log formats](https://docs.openclaw.ai/logging)
-   [File logs (JSONL)](https://docs.openclaw.ai/logging)
-   [Console output](https://docs.openclaw.ai/logging)
-   [Configuring logging](https://docs.openclaw.ai/logging)
-   [Log levels](https://docs.openclaw.ai/logging)
-   [Console styles](https://docs.openclaw.ai/logging)
-   [Redaction](https://docs.openclaw.ai/logging)
-   [Diagnostics + OpenTelemetry](https://docs.openclaw.ai/logging)
-   [OpenTelemetry vs OTLP](https://docs.openclaw.ai/logging)
-   [Signals exported](https://docs.openclaw.ai/logging)
-   [Diagnostic event catalog](https://docs.openclaw.ai/logging)
-   [Enable diagnostics (no exporter)](https://docs.openclaw.ai/logging)
-   [Diagnostics flags (targeted logs)](https://docs.openclaw.ai/logging)
-   [Export to OpenTelemetry](https://docs.openclaw.ai/logging)
-   [Exported metrics (names + types)](https://docs.openclaw.ai/logging)
-   [Exported spans (names + key attributes)](https://docs.openclaw.ai/logging)
-   [Sampling + flushing](https://docs.openclaw.ai/logging)
-   [Protocol notes](https://docs.openclaw.ai/logging)
-   [Log export behavior](https://docs.openclaw.ai/logging)
-   [Troubleshooting tips](https://docs.openclaw.ai/logging)
