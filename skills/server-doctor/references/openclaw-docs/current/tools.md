...
[Skip to main content](https://docs.openclaw.ai/tools)
...
-   [Disabling tools](https://docs.openclaw.ai/tools)
-   [Tool profiles (base allowlist)](https://docs.openclaw.ai/tools)
-   [Provider-specific tool policy](https://docs.openclaw.ai/tools)
-   [Tool groups (shorthands)](https://docs.openclaw.ai/tools)
-   [Plugins + tools](https://docs.openclaw.ai/tools)
-   [Tool inventory](https://docs.openclaw.ai/tools)
-   [apply\_patch](https://docs.openclaw.ai/tools)
-   [exec](https://docs.openclaw.ai/tools)
-   [process](https://docs.openclaw.ai/tools)
-   [loop-detection (tool-call loop guardrails)](https://docs.openclaw.ai/tools)
-   [web\_search](https://docs.openclaw.ai/tools)
-   [web\_fetch](https://docs.openclaw.ai/tools)
-   [browser](https://docs.openclaw.ai/tools)
-   [canvas](https://docs.openclaw.ai/tools)
-   [nodes](https://docs.openclaw.ai/tools)
-   [image](https://docs.openclaw.ai/tools)
-   [pdf](https://docs.openclaw.ai/tools)
-   [message](https://docs.openclaw.ai/tools)
-   [cron](https://docs.openclaw.ai/tools)
-   [gateway](https://docs.openclaw.ai/tools)
-   [sessions\_list / sessions\_history / sessions\_send / sessions\_spawn / session\_status](https://docs.openclaw.ai/tools)
-   [agents\_list](https://docs.openclaw.ai/tools)
-   [Parameters (common)](https://docs.openclaw.ai/tools)
-   [Recommended agent flows](https://docs.openclaw.ai/tools)
-   [Safety](https://docs.openclaw.ai/tools)
-   [How tools are presented to the agent](https://docs.openclaw.ai/tools)
...
Search the web using Brave, Firecrawl, Gemini, Grok, Kimi, or Perplexity. Core parameters:
