...
<!-- Title: Browser (OpenClaw-managed) - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/tools/browser)
...
-   [What you get](https://docs.openclaw.ai/tools/browser)
-   [Quick start](https://docs.openclaw.ai/tools/browser)
-   [Profiles: openclaw vs user](https://docs.openclaw.ai/tools/browser)
-   [Configuration](https://docs.openclaw.ai/tools/browser)
-   [Use Brave (or another Chromium-based browser)](https://docs.openclaw.ai/tools/browser)
-   [Local vs remote control](https://docs.openclaw.ai/tools/browser)
-   [Node browser proxy (zero-config default)](https://docs.openclaw.ai/tools/browser)
-   [Browserless (hosted remote CDP)](https://docs.openclaw.ai/tools/browser)
-   [Direct WebSocket CDP providers](https://docs.openclaw.ai/tools/browser)
-   [Browserbase](https://docs.openclaw.ai/tools/browser)
-   [Security](https://docs.openclaw.ai/tools/browser)
-   [Profiles (multi-browser)](https://docs.openclaw.ai/tools/browser)
-   [Existing-session via Chrome DevTools MCP](https://docs.openclaw.ai/tools/browser)
-   [Isolation guarantees](https://docs.openclaw.ai/tools/browser)
-   [Browser selection](https://docs.openclaw.ai/tools/browser)
-   [Control API (optional)](https://docs.openclaw.ai/tools/browser)
-   [Playwright requirement](https://docs.openclaw.ai/tools/browser)
-   [Docker Playwright install](https://docs.openclaw.ai/tools/browser)
-   [How it works (internal)](https://docs.openclaw.ai/tools/browser)
-   [CLI quick reference](https://docs.openclaw.ai/tools/browser)
-   [Snapshots and refs](https://docs.openclaw.ai/tools/browser)
-   [Wait power-ups](https://docs.openclaw.ai/tools/browser)
-   [Debug workflows](https://docs.openclaw.ai/tools/browser)
-   [JSON output](https://docs.openclaw.ai/tools/browser)
-   [State and environment knobs](https://docs.openclaw.ai/tools/browser)
-   [Security & privacy](https://docs.openclaw.ai/tools/browser)
-   [Troubleshooting](https://docs.openclaw.ai/tools/browser)
-   [Agent tools + how control works](https://docs.openclaw.ai/tools/browser)
...
-   Set `browser.profiles.<name>.userDataDir` when an existing-session profile should attach to a non-default Chromium user profile such as Brave or Edge.
...
-   OpenClaw does not launch the browser for this driver; it attaches to an existing session only.
-   OpenClaw uses the official Chrome DevTools MCP `--autoConnect` flow here. If `userDataDir` is set, OpenClaw passes it through to target that explicit Chromium user data directory.
-   Existing-session screenshots support page captures and `--ref` element captures from snapshots, but not CSS `--element` selectors.
-   Existing-session `wait --url` supports exact, substring, and glob patterns like other browser drivers. `wait --load networkidle` is not supported yet.
-   Some features still require the managed browser path, such as PDF export and download interception.
...
-   `snapshot`:
    ...
    -   Config default (tool/CLI only): set `browser.snapshotDefaults.mode: "efficient"` to use efficient snapshots when the caller does not pass a mode (see [Gateway configuration](https://docs.openclaw.ai/gateway/configuration)).
...
[BTW Side Questions](https://docs.openclaw.ai/tools/btw)[Browser Login](https://docs.openclaw.ai/tools/browser-login)
