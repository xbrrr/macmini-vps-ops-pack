...
[Skip to main content](https://docs.openclaw.ai/tools/browser-login)
...
-   [Browser login + X/Twitter posting](https://docs.openclaw.ai/tools/browser-login)
-   [Manual login (recommended)](https://docs.openclaw.ai/tools/browser-login)
-   [Which Chrome profile is used?](https://docs.openclaw.ai/tools/browser-login)
-   [X/Twitter: recommended flow](https://docs.openclaw.ai/tools/browser-login)
-   [Sandboxing + host browser access](https://docs.openclaw.ai/tools/browser-login)
