...
[Skip to main content](https://docs.openclaw.ai/tools/skills-config)
...
-   [Fields](https://docs.openclaw.ai/tools/skills-config)
-   [Notes](https://docs.openclaw.ai/tools/skills-config)
-   [Sandboxed skills + env vars](https://docs.openclaw.ai/tools/skills-config)
...
[Skills](https://docs.openclaw.ai/tools/skills)[ClawHub](https://docs.openclaw.ai/tools/clawhub)
