...
<!-- Title: apply_patch Tool - OpenClaw -->

[Skip to main content](https://docs.openclaw.ai/tools/apply-patch)
...
-   [Parameters](https://docs.openclaw.ai/tools/apply-patch)
-   [Notes](https://docs.openclaw.ai/tools/apply-patch)
-   [Example](https://docs.openclaw.ai/tools/apply-patch)
...
[Tools](https://docs.openclaw.ai/tools)[Brave Search](https://docs.openclaw.ai/brave-search)
